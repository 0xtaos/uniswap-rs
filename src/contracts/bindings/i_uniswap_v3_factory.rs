...
pub mod i_uniswap_v3_factory {
    ...
    impl ::ethers_core::abi::AbiDecode for IUniswapV3FactoryCalls {
        fn decode(
            ...
            if let Ok(decoded) = <CreatePoolCall as ::ethers_core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CreatePool(decoded));
            }
            if let Ok(decoded) = <EnableFeeAmountCall as ::ethers_core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::EnableFeeAmount(decoded));
            }
            if let Ok(decoded) = <FeeAmountTickSpacingCall as ::ethers_core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::FeeAmountTickSpacing(decoded));
            }
            if let Ok(decoded) = <GetPoolCall as ::ethers_core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetPool(decoded));
            }
            if let Ok(decoded) = <OwnerCall as ::ethers_core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Owner(decoded));
            }
            if let Ok(decoded) = <SetOwnerCall as ::ethers_core::abi::AbiDecode>::decode(
                data,
            ) {
